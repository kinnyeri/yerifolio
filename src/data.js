const PROFILE = {
  ...
  skills: [
    ...
    },
    {
      title: "TypeScript",
      content:
        "Type을 지정하고,이를 체크함으로써 더 안전한 개발이 진행될 수 있다고 판단하여 학습 중에 있습니다.",
    },
    {
      title: "Java",
      content:
  ...
  projects: [
    {
      ...
      details: [
        ...
        "추후 예외처리 로직을 추가하여 비정상적인 접근 등 이슈 발생을 방지할 예정입니다.",
      ],
      links: [
        {
          title: "Git Hub",
      ...
      stacks: [
        ...
        },
        {
          title: "TypeScript",
          content:
            "타입 체크를 통해 개발의 안전성을 높이고, 유지보수가 쉬워지도록 개발하였습니다.",
        },
      ],
    },
    {
      ...
      team: "FE 1명",
      details: [
        "모듈화를 통해 하여 새로운 경험이 생겨도 쉽게 추가할 수 있도록 설계하였습니다.",
      ],
      links: [
        {
          title: "Git Hub",
